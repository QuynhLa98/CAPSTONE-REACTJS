    ...
    useEffect(() => {
        if (isSignUp) {
            ...
            Swal.fire({
                position: 'center',
                icon: 'error',
                text: 'Đăng ký không thành công. Vui lòng thử lại!',
                showConfirmButton: false,
                timer: 1500
            });
            dispatch(clearError());
        ...
        <>
            ...
            <FormSignUp className='formLogin' onSubmit={handleSubmit(onSubmit)}>
                <div>
                    <FormInput>
                        ...
                        <input type="text" {...register('taiKhoan', {
                            required: {
                                value: true,
                                message: 'Tài khoản không được để trống'
                            },
                            minLength: {
                                value: 8,
                    ...
                    <FormInput>
                        ...
                        <input type="password" {...register('matKhau', {
                            required: {
                                value: true,
                                message: 'Mật khẩu không được để trống'
                            },
                            pattern: {
                    ...
                    <FormInput>
                        ...
                        <input type="text" {...register('email', {
                            required: {
                                value: true,
                                message: 'Email không được để trống'
                            },
                            pattern: {
                                value: /^(([^<>()\[\]\.,;:\s@\"]+(\.[^<>()\[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i,
                    ...
                    <FormInput>
                        ...
                        <input type="" {...register('soDt', {
                            required: {
                                value: true,
                                message: 'Số điện thoại không được để trống'
                            },
                            pattern: {
                                value: /[0-9]{10,16}/,
                    ...
                    <FormInput>
                        ...
                        <input type="text" {...register('hoTen', {
                            required: {
                                value: true,
                                message: 'Họ tên không được để trống'
                            },
                            minLength: {
                                value: 5,
                ...
                <div>
                    ...
                    <div>Đã có tài khoản ? <Link to='/register/login'>Đăng nhập ngay !</Link></div>
                </div>
            </FormSignUp>
        </>
    )
