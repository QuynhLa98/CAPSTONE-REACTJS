  ...
  return (
    <ContainerIntro className={themeContext.theme}>
      <ReactPlayer 
        ...
        muted={isMuted}
        loop={true}
        url='https://www.youtube.com/watch?v=pk7NQBW6Mj4' />
      <InfoIntro>
        <h1>MY NEIGHBOR TOTORO</h1>
        <p>“My Neighbor Totoro” can be considered one of Hayao Miyazaki's first major animated films. This job is fun, pure, suitable for all ages and all situations. It begins a series of hand-drawn animations afterward.</p>
      </InfoIntro>
      {
        isMuted ? (
